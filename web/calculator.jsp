    ...
    <body>
        <%
            ...
            if (request.getParameter("add") != null) {
                out.print("The result of " + num1 + "+" + num2 + " = " + add);
            } else if (request.getParameter("sub") != null) {
                out.print("The result of " + num1 + "-" + num2 + " = " + sub);
            } else if (request.getParameter("mul") != null) {
                out.print("The result of " + num1 + "*" + num2 + " = " + mul);
            } else if (request.getParameter("div") != null) {
                if (num2.equals("0")) {
                    out.print("The result of " + num1 + "/" + num2 + " = Error divide by 0");
                } else {
                    out.print("The result of " + num1 + "/" + num2 + " = " + div);
                }
            }
